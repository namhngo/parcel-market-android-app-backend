...
namespace Gis.UnitTest.Services
{
    ...
    {               
        ...
        #region Init Service
        private async Task<Gis.API.Service.Sys_Role.Service> CreateServiceAsync()
        {            
            ...
            return new Gis.API.Service.Sys_Role.Service(_context, _dateTimeProvider.Object, _userProvider.Object);
        }
