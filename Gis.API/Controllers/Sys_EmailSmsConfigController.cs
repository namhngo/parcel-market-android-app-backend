...
{
    public class Sys_EmailSmsConfigController : ApiControllerBase<Sys_EmailSms>
    {
        private readonly IServiceWrapper _service;
        private readonly ILogger<Sys_EmailSmsConfigController> _logger;
        public Sys_EmailSmsConfigController(IServiceWrapper service, ILogger<Sys_EmailSmsConfigController> logger) :base(service, logger)
        {
            _service = service;
            _logger = logger;
        }
