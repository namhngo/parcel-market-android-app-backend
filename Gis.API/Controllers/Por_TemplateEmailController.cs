...
{
    public class Por_TemplateEmailController : ApiControllerBase<Por_TemplateEmail>
    {
        private readonly IServiceWrapper _service;
        private readonly ILogger<Por_TemplateEmailController> _logger;
        public Por_TemplateEmailController(IServiceWrapper service, ILogger<Por_TemplateEmailController> logger) :base(service, logger)
        {
            _service = service;
            _logger = logger;
        }
        ...
        public async Task<IActionResult> CheckDuplicateAttributes(Guid? id, string ma)
        {
            try
            {
                ...
                var result = await _service.Por_TemplateEmail.IsDupicateAttributesAsync(id, ma);
