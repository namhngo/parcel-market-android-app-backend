...
{
    public class Por_TemplateSmsController : ApiControllerBase<Por_TemplateSms>
    {
        private readonly IServiceWrapper _service;
        private readonly ILogger<Por_TemplateSmsController> _logger;
        public Por_TemplateSmsController(IServiceWrapper service, ILogger<Por_TemplateSmsController> logger) :base(service, logger)
        {
            _service = service;
            _logger = logger;
        }
